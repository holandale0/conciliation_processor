		...
		RAISE NOTICE 'Regra 3';
           ...
           has_settlement := (settlement_datetime_converted IS NOT NULL AND settlement_datetime_converted::date <= NOW()::date);
            ...
            IF has_settlement = true THEN  -- Início IF Regra 3.1
            	...
            	RAISE NOTICE 'Regra 3.1';

	             -- Atualiza a transação como conciliada, pois foi liquidada
             ...
             elsif settlement_datetime_converted IS NOT NULL and settlement_datetime_converted::date > NOW()::date then -- elsif Regra 3.1
             	...
             	RAISE NOTICE 'Regra 3.3 - Apenas ignora e não faz nada, pois pode ser que a informação de liquidação ainda não tenha vindo';

			 end if; -- end if regra 3.1
