...
BEGIN
    ...
    ELSE  -- Else Regra 1
		...
		RAISE NOTICE 'Regra 3';
            ...
            -- Encontrou a transação correspondente na tabela "transactions", então marca como conciliado = true
