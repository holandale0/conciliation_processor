           ...
           has_fee := (customer_fee_record IS NOT NULL);
            ...
            IF has_settlement = true THEN  -- Início IF Regra 3.1
            	...
            	IF has_fee = true then  -- Início IF Regra 3.1.1
            		...
            		-- Regra 3.1.1.1 : Verifica se as taxas são iguais

                	IF COALESCE(customer_fee_record.fee,0) = COALESCE(in_fee,0) THEN  -- Início IF Regra 3.1.1.1
